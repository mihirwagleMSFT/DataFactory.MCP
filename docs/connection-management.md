...
# Create cloud SQL connection
> create a cloud SQL connection to server.database.windows.net with username myuser

# Create VNet SQL connection  
> create a VNet SQL connection using gateway 7d3b5733-732d-4bbe-8d17-db6f6fe5d19c
```